...
public class ItemQuantumGoggle extends ItemArmor {
    public ItemQuantumGoggle() {
        ...
        setRegistryName("qcraft:goggles");
        setTranslationKey("qcraft.goggles");
    ...
    public void renderHelmetOverlay(ItemStack stack, EntityPlayer player, ScaledResolution resolution, float partialTicks){
        QCraft.proxy.renderQuantumGoggle(resolution);
    }
}
