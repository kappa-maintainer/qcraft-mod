...
public class GuiItemTransfer extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString( this.fontRenderer, I18n.format( "gui.qcraft:item_transfer.line1", m_destinationServerName ), this.width / 2, 70, 16777215 );
        this.drawCenteredString( this.fontRenderer, I18n.format( "gui.qcraft:item_transfer.line2", m_destinationServerName ), this.width / 2, 90, 16777215 );
