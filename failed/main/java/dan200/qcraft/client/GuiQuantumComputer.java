...
public class GuiQuantumComputer extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        m_localPortalIDField = new GuiTextField(0, fontRenderer, x + 9, y - 20, xSize - 18, 20 );
        ...
        m_destinationPortalIDField = new GuiTextField(1, fontRenderer, x + 9, y + 8 + 8,  xSize - 18, 20 );
        ...
        m_newServerAddressField = new GuiTextField(2, fontRenderer, x + 9, y + 8 + 8 + 20 + 7, xSize - 18 - 35 - 3, 18 );
    ...
    protected void drawGuiContainerForegroundLayer( int i, int j )
    {
        ...
        if( m_container.isTeleporterPresent() )
        {
            ...
            fontRenderer.drawString( text, 9, -20 - 3 - 8, 0x404040 );

            String text2 = I18n.format( "gui.qcraft:computer.remote_portal" );
            fontRenderer.drawString( text2, 9, 5, 0x404040 );
        }
    }
